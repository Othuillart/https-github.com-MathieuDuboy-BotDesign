        ...
        if(lasession[sessionId].context["question_actuelle"] == 'histoire_allergie_medicament_detail_1') {
          ...
          resp.forEach(function(element) {
            ...
            extras.buttons.push({
                ...
                "response" : a+"_histoire_allergie_medicament_detail_1_confirmation",
                "value" : a+"_histoire_allergie_medicament_detail_1_confirmation"
            });
            a++;
          });
          extras.buttons.push({
              ...
              "response" : "Aucun_histoire_allergie_medicament_detail_1_confirmation",
              "value" : "Aucun_histoire_allergie_medicament_detail_1_confirmation"
          });
          ...
          resp.forEach(function(element) {
            ...
            extras.buttons.push({
                ...
                "name" : fonctions.base64_encode(element.denomination),
                "response" : a+"_histoire_allergie_medicament_detail_2_confirmation",
                "value" : a+"_histoire_allergie_medicament_detail_2_confirmation"
            });
            a++;
          });
          extras.buttons.push({
              ...
              "name" : fonctions.base64_encode("Aucun dans la liste"),
              "response" : "Aucun_histoire_allergie_medicament_detail_2_confirmation",
              "value" : "Aucun_histoire_allergie_medicament_detail_2_confirmation"
          });
          reponse.messages.push({"message" : message_retour_crypte1, "extras" : extras});
          resolve({reponse});
        }
          ...
          resp.forEach(function(element) {
            ...
            extras.buttons.push({
                ...
                "name" : fonctions.base64_encode(element.denomination),
                "response" : a+"_histoire_allergie_medicament_detail_3_confirmation",
                "value" : a+"_histoire_allergie_medicament_detail_3_confirmation"
            });
            a++;
          });
          extras.buttons.push({
              ...
              "name" : fonctions.base64_encode("Aucun dans la liste"),
              "response" : "Aucun_histoire_allergie_medicament_detail_3_confirmation",
              "value" : "Aucun_histoire_allergie_medicament_detail_3_confirmation"
          });
          reponse.messages.push({"message" : message_retour_crypte1, "extras" : extras});
          resolve({reponse});
        }
           ...
           case "histoire_traitement":
            ...
            case "histoire_probleme_neurologique":
              ...
              var extras = {
                ...
                {
                    "id" : "hernie_histoire_probleme_neurologique",
                    "name" : fonctions.base64_encode("Hernie discale, sciatique"),
                    "response" : fonctions.base64_encode("pneumo_histoire_probleme_respiratoire"),
                    "value" : fonctions.base64_encode("pneumo_histoire_probleme_respiratoire")
                },
                {
